...
if (!class_exists('SPS_Post_Meta')) {
    ...
    class SPS_Post_Meta {
        ...
        function register_meta_settings()
        {
            ...
            add_meta_box(
                'sps_websites', 
                __('Select Websites', 'friday_sync_text_domain'),
        ...
        public function print_meta_fields()
        {
            global $post;
            ?>
            <button class="components-button editor-post-publish-button" id="friday-sync-button" data-post-id="<?php echo $post->ID;?>">Sincronizza</button>
            <?php
        }
        
        public function old_print_meta_fields()
        {
            ...
            echo "<br/>";
            echo '<div class="meta_description"><p>' . __('select which website you want to add/edit post with this post.', 'friday_sync_text_domain') . '</p></div>';
            echo '</div><!-- end inner -->';
